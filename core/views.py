...
def settle_payment(request):
    ...
    if request.method == "POST":
        ...
        from django.urls import reverse
        from decimal import Decimal
        from core.models import Client, ClientExchange, Transaction
        ...
        if client_id and client_exchange_id and amount > 0 and tx_date:
            try:
                ...
                with db_transaction.atomic():
                    # Create simple SETTLEMENT transaction
...
def pending_summary(request):
    ...
    for client_exchange in client_exchanges:
        ...
        if is_loss_case:
            # TODO: Add your new formulas for calculating pending when client owes you
        ...
        if is_profit_case:
            # TODO: Add your new formulas for calculating pending when you owe client
